...
import 'package:lifestep/features/main_app/presentation/widgets/buttons/advanced_button.dart';
...
class Utils {
  ...
  static String? checkNullToString(dynamic key) {
    if(key != null){
      return key.toString();
    }
    return null;
  ...
  static String? checkNullToEmptyString(dynamic key) {
    if(key != null){
      return key.toString();
    }
    return '';
  }
  static int checkNullToZero(dynamic key) {
    try {
      if (key != null) {
...
// Define a reusable function
  ...
  static void launchUrl(String value) {
    try{
      launch(value.contains('http') ? value : sprintf("%s%s", [EndpointConfig.siteUrl, value]));
    }catch(_){
    }
  }
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.symmetric(horizontal: 20.0, vertical: 20),
                    child: Image.asset(errorCode == null ? "assets/images/error/went-wrong.png" : errorCode == WEB_SERVICE_ENUM.internetError ? "assets/images/error/internet.png" : errorCode == WEB_SERVICE_ENUM.unexpectedError ? "assets/images/error/server.png" : "assets/images/error/went-wrong.png"),
                  ),
                  if(title!=null)
                  Container(
                    padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 24),
