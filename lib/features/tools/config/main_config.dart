...
class MainConfig {
  ...
  static const String appName = debug ? 'LifeStep test' : 'LifeStep';

  static const String appMetricaConfig = debug ? '-' : '72b95a64-bed7-4932-8b02-c9e9899bfc6d';
  static const String appUxCamConfig = debug ? '-' : 'sw8hux7lvw9aaal';

  static const String appFlurryConfigAndroid = '3KVR7BC2247MR22F7YNG';
  static const String appFlurryConfigIos = 'YVG74KDTQVWM2VBT78PP';

  static const String appVersion = '1.0.41';

  static const int appVersionAndroid = 41;
  static const int appVersionIos = 41;

  static const String appUrl = 'https://lifestep.az';
  static const String appPlayStoreUrl = 'https://play.google.com/store/apps/details?id=az.lifestep';
  static const String appAppSotreUrl = 'https://apps.apple.com/az/app/lifestep-steps-to-charity/id1613896644';
...
// static const main_language_list = [Locale('en', 'US'), Locale('ar', 'DZ')];
  ...
  ///
  // static const String mainMapApiKey = 'AIzaSyBGbriAvr7gcfh2tqPnrlBRHaEB841oro0';
  // static const String mainMapApiKey = 'AIzaSyCCNzxwr6Va-VLthLzobEH37Tyc9uQJeVk';
  static const String mainMapApiKey = 'AIzaSyCpl9GHLXYw-u-VALEYNyDVAueci3mQxuM';
  ...
  static const int mainAppDataCount = 12;


  static const int mainStepDataCount = 10;
