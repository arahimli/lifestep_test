...
class EndpointConfig {
  ...
  static const String apiBaseUrl = 'https://${MainConfig.debug ? 'app-dev' : 'app'}.lifestep.az';
  ...
  static const String deleteUserUrl = 'user-profile-delete';
  static const String deleteConfirmOtp = 'user-profile-delete-confirm';

  static String getSlider = 'banners';
  static String homeCharities = 'home-charities';
  static String homeFunds = 'home-funds';
  static String homeChallenges = 'home-challenges';
