...
import 'package:lifestep/features/main_app/presentation/widgets/shimmers/achievement_list_item.dart';
import 'package:lifestep/features/main_app/presentation/widgets/shimmers/skeleton_grid.dart';
    ...
    return BlocBuilder<AchievementListCubit, AchievementListState>(
      builder: (context, state) {
        if(state is AchievementListSuccess) {
          ...
          return const SkeletonGridViewWidget(
            crossAxisSpacing: 10.0,
            mainAxisSpacing: 10.0,
