...
import 'package:lifestep/features/main_app/presentation/widgets/shimmers/user/history.dart';
            ...
            Flexible(
              ...
              child: BlocConsumer<DonationHistoryListBloc, DonationHistoryListState>(
                  listener: (context, state){
                    if(state is DonationHistoryListError && state.errorCode == WEB_SERVICE_ENUM.unAuth){
                    ...
                    if(state is DonationHistoryListSuccess) {
                      ...
                      NotificationListener(
                        onNotification: (t) {
                          if (t is ScrollEndNotification) {
                            context.read<DonationHistoryListBloc>().search(
                                null);
                            return true;
                          } else {
                            return false;
                        ...
                        child: LayoutBuilder(
                            builder: (context, constraints) {
                              return RefreshIndicator(
                                onRefresh: () async {
                                  await context.read<DonationHistoryListBloc>()
                                      .refresh();
                                },
                                  ...
                                  child: SingleChildScrollView(
                                      ...
                                      child: ConstrainedBox(
                                        ...
                                        child: Column(
                                          children: [
                                            for(int i = 0; i <
                                                state.dataList!.length; i++)
                                              _DataItemWidget(
                                                dataItem: state.dataList![i],),
                      ...
                      ListMessageWidget(
                        ...
                        text: Utils.getString(
                            context, "general__list__empty_message"),
                      );
                    }
