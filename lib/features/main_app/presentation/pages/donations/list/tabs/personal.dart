...
import 'package:lifestep/features/main_app/presentation/widgets/shimmers/donations/personal.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<CharityListCubit, CharityListState>(
        listener: (context, state){
          if(state is CharityListError && state.errorCode == WEB_SERVICE_ENUM.unAuth){
        ...
        builder: (BuildContext context, state){
          if(state is CharityListSuccess || state is CharityUpdateListSuccess) {
            ...
            return SkeletonListWidget(
              ...
              child: const PersonalDonationListItemShimmerWidget(),
            );
          }
