...
import 'package:lifestep/features/main_app/presentation/widgets/shimmers/notification_list_item.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<NotificationListCubit, NotificationListState>(
        listener: (context, state){
          if(state is NotificationListError && state.errorCode == WEB_SERVICE_ENUM.unAuth){
        ...
        builder: (BuildContext context, state){
          ...
          SkeletonListWidget(
            ...
            child: const NotificationListItemShimmerWidget(),
          );
        }
    );
  }
