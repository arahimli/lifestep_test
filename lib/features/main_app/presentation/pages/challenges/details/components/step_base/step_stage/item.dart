                ...
                children: [
                  Text.rich(
                      TextSpan(
                          children: [
                            TextSpan(
                              text: challengeModel.isJoined! ? humanizeInt(context, userSteps) : humanizeInt(context, dataItem.goal ?? 0),
                            ...
                            if(challengeModel.isJoined!)
                            TextSpan(
                                text: " ${humanizeInt(context, dataItem.goal ?? 0)} ${Utils.getString(context, "general__steps__count")}",
