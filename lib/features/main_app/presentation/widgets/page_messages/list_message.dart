            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    padding: EdgeInsets.symmetric(horizontal: size.width * 1.5 / 10),
                    child: Image.asset(widget.errorCode == null ? "assets/images/error/went-wrong.png" : widget.errorCode == WEB_SERVICE_ENUM.internetError ? "assets/images/error/internet.png" : widget.errorCode == WEB_SERVICE_ENUM.unexpectedError ? "assets/images/error/server.png" : "assets/images/error/went-wrong.png"),
                  ),
                  Container(
                    padding: EdgeInsets.symmetric(horizontal: size.width * 1.2 / 10, vertical: 32),
                    child: Text(widget.text, style: MainStyles.boldTextStyle.copyWith(fontSize: 20),),
