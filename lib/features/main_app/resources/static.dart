...
class StaticRepository implements IStaticRepository{
  ...
  Future<List> checkUpdate() async {
    String requestUrl = sprintf(EndpointConfig.appVersionCheck, [Platform.isAndroid ? 2 : 1, Platform.isAndroid ? MainConfig.appVersionAndroid : MainConfig.appVersionIos]);
    ////// print(requestUrl);
    List data = await WebService.getCall(url: requestUrl);
    return data;
  }
