...
import 'package:lifestep/tools/components/shimmers/user/history.dart';
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            //     padding: EdgeInsets.symmetric(vertical: size.height / (836 / 12), horizontal: size.width / (375 / 16)),
              ...
              child: BlocConsumer<DonationHistoryListBloc, DonationHistoryListState>(
                  ...
                  builder: (BuildContext context, state){
                    if(state is DonationHistoryListSuccess)
                      return state.dataList != null && state.dataList!.length > 0 ?
