...
import 'package:lifestep/pages/challenges/challenge/logic/polyline/cubit.dart';
import 'package:lifestep/pages/challenges/challenge/logic/step/cubit.dart';
import 'package:lifestep/pages/challenges/challenge/view.dart';
...
import 'package:lifestep/pages/challenges/preview_map/logic/state.dart';
import 'package:lifestep/pages/challenges/preview_map/view.dart';
...
class _ChallengeDetailViewState extends State<ChallengeDetailView> with WidgetsBindingObserver{
  ...
  Widget build(BuildContext context) {
    ...
    double _panelHeightClosed = size.height * 4 / 10 - 64;
          ...
          child: Row(
            ...
            children: <Widget>[
              Container(
                  ...
                  child: Image.asset(participantModel.genderType == GENDER_TYPE.MAN ? MainConfig.defaultMan : MainConfig.defaultWoman,
