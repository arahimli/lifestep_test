...
import 'package:lifestep/model/challenge/challenge-success.dart';
...
import 'package:lifestep/pages/challenges/challenge/logic/polyline/state.dart';
                      ...
                      Expanded(
                        child: BlocBuilder<PolylineMapCubit, PolylineMapState>(
                          builder: (context, polylineMapState) {
                            ...
                            //       polylineMapState.polylines.values.length > 0)
                            //     _controller!
                            //         .animateCamera(
