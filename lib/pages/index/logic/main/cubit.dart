...
import 'package:lifestep/model/home/challenge-list.dart';
import 'package:lifestep/model/home/charity-list.dart';
import 'package:lifestep/model/home/fond-list.dart';
import 'package:lifestep/model/index/banner.dart';
import 'package:lifestep/model/index/page.dart';
...
class IndexCubit extends Cubit<IndexState>{
  ...
  Future<void> initialize() async{
    ...
    List sliderList = await this.getSlider();
    ...
    List challengeList = await this.homeChallenges()
    ;
